...
이정표 앞 돌에 보라조각이 있습니다. 맵 왼쪽 아래에 있는 쓰레기통에 파랑조각과 평범한사탕이 있습니다.
...
이번 스토리 진행 중에 밖으로 나올 경우 관계 포인트가 감소하니, 준비한 후 진행하시는 것이 좋습니다.

매 배틀 후 팀이 완전히 회복되므로 상처약 등 회복 도구는 따로 구비하실 필요가 없습니다.

정원 위에 있는 모스워터 산업공장으로 향하거나, 페리도트 구 남부에 있는 체육관으로 먼저 가실 수 있습니다.
