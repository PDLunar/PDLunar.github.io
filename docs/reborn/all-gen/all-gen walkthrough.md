...
- 동굴탈출로프, 마비치료제, 엘리멘탈시드, 보라조각, 파랑조각, 평범한사탕
...
포켓몬센터 왼쪽에는 엘리멘탈시드와 트레이너가 오기 전에 지나쳤던 길로 내려가면 보라조각과 트레이너들이 있습니다.
...
오른쪽 골목에는 트레이너와 파랑조각이 있고, 포켓스낵을 지닌 채로 쓰레기통에 말을 걸면 꼴깍몬이 나옵니다. 오른쪽에는 평범한사탕이 있습니다.
