...
쾌청인 날씨에 아침과 낮 시간대에 옵시디아 공원에서 **치릴리**를 얻을 수 있습니다.
...
- 이펙트가드, 치리열매, 슈퍼볼, 스피드업, 해독제, 초록조각, 캄라열매, 해독제, 마비치료제, 파랑조각, 만병통치제, 경험사탕S, 파랑조각
...
왼쪽 감옥으로 가는 길에는 캄라열매가, 오른쪽 감옥으로 가는 길에는 해독제와 마비치료제가 있습니다.
...
건물 안에 있는 남성이 해너츠와 학습장치를 지니고 있는 **흉내내, 트리미앙, 프리지오, 멜리시** 중 한 마리와 교환해줍니다.
