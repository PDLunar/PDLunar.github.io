...
이번 스토리 진행 중에 다른 곳으로 이탈할 경우 관계 포인트가 감소할 수 있으니, 준비한 후 진행하시는 것이 좋습니다.

매 배틀 후 팀이 완전히 회복되므로 상처약 등 회복 도구는 따로 구비하실 필요가 없습니다.

정원 바로 위에 있는 모스워터 산업공장으로 향하거나, 페리도트 구 남부에 있는 체육관으로 먼저 가실 수 있습니다.
...
이후엔 배틀 중 필드 효과에 영향받는 기술을 표시할지 물어보며, 이 기능은 게임 설정에서도 키거나 끌 수 있습니다.
