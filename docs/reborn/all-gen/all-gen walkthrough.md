...
TV에선 특정 스토리가 진행된 후 여러 가지 소식과 정보를 접할 수 있으니 생각날 때마다 보면 좋습니다.
...
왼쪽 건물로 가면 쓰러진 쓰레기통이 있습니다. 여기서는 특성캡슐을 얻을 수 있는데
...
왼쪽 쓰레기통에는 아이템이 있지만 현재는 얻을 수 없으니, 오른쪽 에스컬레이터를 타고 내려가세요.
...
에스컬레이터 사이로 지나가 문 옆 돌에서 골드스프레이를 얻을 수 있습니다.
...
빅토리아가 있던 자리로 돌아가서, 이전에 얻지 못했던 포켓스낵을 얻어줍니다.
...
이 알에서 나오는 포켓몬은 **진주몽, 깨물부기, 백색근의 모습 배쓰나이, 대굴레오, 가비루사, 쥬쥬, 완철포** 중 하나입니다.
...
<br><br>
버섯포자를 무효로 할 수 있는 독/풀 타입과 땅타입을 무효로 하는 비행타입도 유용합니다.
<br><br>
...
코리에게 원하는 대로 답을 한 뒤, 왼쪽에서는 초록조각과 디펜드업을, 오른쪽에선 큰뿌리를 얻습니다.
...
건물과 건물 사이에 있는 통로 아래 돌에서 포켓스낵을 얻을 수 있습니다.
...
오른쪽 구역에서 초록조각과 좋은상처약을 얻고, 중간에 있는 작은 건물로 갑니다.
...
베릴 대교에서는 하트비늘과 스피드업을, 유레유발전소 근처에서는 포켓스낵을 얻을 수 있습니다.
...
길 모퉁이에서 빨간조각을 찾을 수 있으며, 건물 안에서는 플러스파워를 얻을 수 있습니다.
...
계단을 오르기 전에 아래 돌에서 경험사탕XS을 얻고, 위로 올라갑니다.
...
나무를 베어준 뒤 왼쪽 계단을 올라갑니다. 스피드업을 주운 후 위로 올라갑니다.
...
밖으로 나와 위쪽 계단을 오릅니다. 중간에 초록조각을 줍고 계속 위로 올라갑니다.
