...
밖으로 나와 오른쪽으로 진행합니다. 바로 앞 건물로 들어가면 다친 에나비가 있습니다.

NPC에게 말을 걸어 오랭열매를 주면 에나비를 줍니다.
...
다음 건물에는 앞서 찾았던 선물상자를 되돌려주고 딜리버드를 줍니다.

맨 오른쪽에 있는 건물로 들어가서 말을 걸면 귀뚤뚜기를 얻을 수 있습니다.

**관계 포인트**
- 귀뚤뚜기 받기 수락 (은일 +1)
- 귀뚤뚜기 받기 거절 (은일 -1)

밖으로 나와 왼쪽에 있는 노란머리 NPC와 배틀을 합니다.
