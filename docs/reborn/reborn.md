...
- 레벨캡 존재 ( 소지한 배지마다 특정 레벨 이상으로 올라가면 말을 듣지 않는 구간이 존재 <br> 해결법은 **비밀번호** 참고)</br>
- 편의를 위한 비밀번호 적용하기
...
처음 시작시 입력을 할 수 있으며
인게임에서 얻을수 있는 데이터칩<img alt="데이터칩" src="/img/reborn/데이터칩.png"/>을 사용해 비밀번호 입력 가능
...
| 비밀번호 |  효과  |
|:-------------|:-------------------------------------------------------------------|
| mono( ~타입 etc- normal , fire ... ) | 포켓몬 획득 이벤트에서 특정 타입을 얻게한다 |
